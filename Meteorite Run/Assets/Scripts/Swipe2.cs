...
{ 
    ...
    void Start()
    {
        pos = 0;
        Move = true;
        Right = new Vector3(1.6f, -2f, player.transform.position.z);
        Center = new Vector3(0, -2f, player.transform.position.z);
        Left = new Vector3(-1.6f, -2f, player.transform.position.z);
    }
