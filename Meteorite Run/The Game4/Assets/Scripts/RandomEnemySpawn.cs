...
public class RandomEnemySpawn : MonoBehaviour {
    ...
    void Start () {
        ...
        Enemy1.transform.localScale = Enemy1.transform.localScale / 2;
        Enemy2.transform.localScale = Enemy2.transform.localScale / 2;
        Enemy3.transform.localScale = Enemy3.transform.localScale / 2;
        var = 0;
    }
	...
	void Update () {
        if (player.transform.position.y == 0 && player)
        {
            ...
            desiredPosition = new Vector2(Enemy1.transform.position.x, -4f);
            desiredPositionClone = new Vector2(Enemy2.transform.position.x, -4f);
            desiredPosition3 = new Vector2(Enemy3.transform.position.x, -4f);
            ...
            if (Enemy1.transform.position.y <= -4f)
            {
                Points++;
                ver1 = 0;
                ver2 = 0;
            ...
            if (ver1 == 3 && Enemy2.transform.position.y <= -4f)
            {
                Points++;
                ver1 = 0;
                ver2 = 0;
            ...
            if (ver2 == 15 && Enemy3.transform.position.y <= -4f)
            {
                Points++;
                ver1 = 0;
                ver2 = 0;
            ...
            if ((Mathf.Abs(Enemy1.transform.position.x - player.transform.position.x))<1 && Mathf.Abs(Enemy1.transform.position.y - player.transform.position.y) < 0.5f)
            {
                ...
                k--;
                Enemy1.transform.position = new Vector2(Enemy1.transform.position.x, -4f);
                lives--;
                ver1 = 0;
                ver2 = 0;
                PS.SetActive(false);
            ...
            if ((Mathf.Abs(Enemy2.transform.position.x - player.transform.position.x)) < 1 && Mathf.Abs(Enemy2.transform.position.y - player.transform.position.y) < 1f)
            {
                ...
                ver1 = 0;
                ver2 = 0;
                Enemy2.transform.position = new Vector2(Enemy2.transform.position.x, -4f);
                PS.SetActive(false);
                PS.SetActive(true);
            }
            if ((Mathf.Abs(Enemy3.transform.position.x - player.transform.position.x)) < 1 && Mathf.Abs(Enemy3.transform.position.y - player.transform.position.y) < 1f)
            {
                ...
                ver1 = 0;
                ver2 = 0;
                Enemy3.transform.position = new Vector2(Enemy3.transform.position.x, -4f);
                PS.SetActive(false);
                PS.SetActive(true);
            }
